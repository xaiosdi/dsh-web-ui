...
Install the standalone plugin package (this repo is a single dsh plugin):
...
git clone https://github.com/xaiosdi/dsh-web-ui.git
cd dsh-web-ui
...
> `github:<org>/<repo>` installs work for this standalone repo, whose package
...
> `pnpm-workspace.yaml` `allowBuilds` and re-run). Local development uses
> the `link:` form above.
